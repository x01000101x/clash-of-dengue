...
<script>
import QuizGameMobile from '../mobile/QuizGameMobile.vue';
    ...
    methods: {
        updateCurrentPage() {
            ...
            if (window.innerWidth < 800) {
                this.currentPage = QuizGameMobile; // Set to LandingPageMobile for mobile screens
            } else {
                this.currentPage = QuizGame; // Set to LandingPage for larger screens
            }
        },
    },
};
